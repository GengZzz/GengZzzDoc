  ...
  <div class="zval-demo">
    ...
    <div class="zval-grid">
      ...
      >
        ...
        <div class="zval-body">
          <div class="field">
            <span class="label">refcount</span><span class="val">{{ z.refcount }}</span>
          </div>
          <div class="field">
            <span class="label">is_ref</span><span class="val">{{ z.is_ref }}</span>
          </div>
          <div class="field">
            <span class="label">value</span><span class="val">{{ z.value }}</span>
          </div>
        </div>
      </div>
    </div>
