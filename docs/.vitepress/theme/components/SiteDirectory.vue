  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        title: 'SonarQube',
        desc: '代码质量与安全。',
        link: 'https://docs.sonarsource.com/sonarqube/',
        color: '#4e9bcd',
      },
      {
        title: 'VitePress',
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        title: '腾讯云',
        desc: '腾讯云官方文档。',
        link: 'https://cloud.tencent.com/document',
        color: '#2563eb',
      },
      {
        title: '华为云',
      ...
      },
      {
        title: 'Namecheap',
        desc: '域名注册与管理。',
        link: 'https://www.namecheap.com/support/',
        color: '#f97316',
      },
      {
        title: 'DigitalOcean',
...
const activeGroup = computed(
  () => groups.find((group) => group.name === activeName.value) ?? groups[0],
);
