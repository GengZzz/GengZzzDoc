...
export const sidebar: DefaultTheme.Sidebar = {
  ...
  '/backend/java/': [
    ...
    },
    {
      ...
      items: [
        ...
        {
          text: 'List 与 ArrayList / LinkedList',
          link: '/backend/java/list-arraylist-linkedlist',
        },
  ...
  '/backend/php/': [
    ...
    },
    {
      text: '安全',
      collapsed: true,
      items: [{ text: 'Web 安全', link: '/backend/php/security' }],
    },
    {
      text: '部署与调优',
      collapsed: true,
  ...
  '/backend/framework/spring/': [
    ...
    },
    {
      ...
      items: [
        {
          text: 'IoC 容器与 Bean 生命周期',
          link: '/backend/framework/spring/ioc-bean-lifecycle',
        },
    ...
    },
    {
      text: 'AOP 与事务',
      collapsed: false,
      items: [{ text: '代理与事务边界', link: '/backend/framework/spring/aop-transaction' }],
    },
    {
      text: '工程实践',
      collapsed: false,
      items: [
        {
          text: '事件、资源与环境',
          link: '/backend/framework/spring/events-resources-profile',
        },
  ...
  '/backend/framework/springboot/': [
    ...
    },
    {
      ...
      items: [
        {
          text: '自动配置与条件注解',
          link: '/backend/framework/springboot/auto-configuration',
        },
        {
          text: '配置绑定与多环境',
          link: '/backend/framework/springboot/configuration-profile',
        },
      ],
    },
    {
    ...
    },
    {
      ...
      items: [
        ...
        {
          text: '常见问题与实践',
          link: '/backend/framework/springboot/troubleshooting-practice',
        },
      ],
    },
  ],
  '/backend/framework/mybatis/': [
    ...
    },
    {
      ...
      items: [
        {
          text: '会话、Mapper 与 SQL 写法',
          link: '/backend/framework/mybatis/session-mapper-sql',
        },
        {
          text: '参数绑定与动态 SQL',
          link: '/backend/framework/mybatis/parameters-dynamic-sql',
        },
    ...
    },
    {
      ...
      items: [
        ...
        {
          text: '插件、分页与批量写入',
          link: '/backend/framework/mybatis/plugins-pagination-batch',
        },
      ],
    },
    {
      ...
      items: [
        {
          text: 'Spring 集成与常见坑',
          link: '/backend/framework/mybatis/spring-integration-practice',
        },
      ],
    },
  ],
  '/backend/framework/mybatisplus/': [
    ...
    },
    {
      ...
      items: [
        {
          text: 'Mapper、Service 与通用 CRUD',
          link: '/backend/framework/mybatisplus/mapper-service-crud',
        },
        {
          text: 'Wrapper 条件构造器',
          link: '/backend/framework/mybatisplus/wrapper-condition',
        },
      ],
    },
    {
      ...
      items: [
        {
          text: '实体映射、自动填充与逻辑删除',
          link: '/backend/framework/mybatisplus/entity-fill-logic-delete',
        },
        {
          text: '插件、分页与多租户',
          link: '/backend/framework/mybatisplus/plugin-pagination-tenant',
        },
      ],
    },
    {
      ...
      items: [
        {
          text: '代码生成与日常实践',
          link: '/backend/framework/mybatisplus/generator-practice',
        },
      ],
    },
  ],
  '/backend/framework/laravel/': [
    ...
    },
    {
      ...
      items: [
        {
          text: '服务容器与服务提供者',
          link: '/backend/framework/laravel/container-service-provider',
        },
        {
          text: '请求生命周期与中间件',
          link: '/backend/framework/laravel/request-middleware-controller',
        },
    ...
    },
    {
      ...
      items: [
        {
          text: '校验、认证与测试',
          link: '/backend/framework/laravel/validation-auth-testing',
        },
        {
          text: '队列、任务与部署实践',
          link: '/backend/framework/laravel/queue-deployment-practice',
        },
      ],
    },
  ],
  '/backend/framework/thinkphp/': [
    ...
    },
    {
      ...
      items: [
        {
          text: '路由、中间件与控制器',
          link: '/backend/framework/thinkphp/routing-middleware-controller',
        },
        {
          text: '容器、门面与配置',
          link: '/backend/framework/thinkphp/container-facade-config',
        },
    ...
    },
    {
      ...
      items: [
        {
          text: '验证、缓存、队列与事件',
          link: '/backend/framework/thinkphp/validation-cache-queue',
        },
  ...
  '/frontend/vue/': [
    {
      ...
      items: [
        ...
        { text: '自定义指令与插件', link: '/frontend/vue/directives-plugins' },
        { text: '路由', link: '/frontend/vue/router' },
        { text: '状态管理', link: '/frontend/vue/pinia' },
        { text: '性能优化', link: '/frontend/vue/performance' },
        { text: 'TypeScript 集成', link: '/frontend/vue/typescript' },
        { text: '组件测试', link: '/frontend/vue/testing' },
        { text: 'SSR 与 Nuxt', link: '/frontend/vue/ssr-nuxt' },
      ],
    },
  ],
  '/frontend/vite/': [
  ...
  '/frontend/html/': [
    ...
    },
    {
      text: '表格与数据',
      collapsed: false,
      items: [{ text: '表格', link: '/frontend/html/tables-data' }],
    },
    {
      text: '可访问性',
      collapsed: false,
      items: [{ text: '无障碍访问', link: '/frontend/html/accessibility' }],
    },
    {
      text: 'Web Components',
      collapsed: true,
  ...
  '/database/postgresql/': [
    ...
    },
    {
      text: '运维与安全',
      collapsed: true,
      items: [{ text: '运维与安全', link: '/database/postgresql/operations-security' }],
    },
  ],
  '/database/redis/': [
    {
  ...
  '/database/elasticsearch/': [
    {
      ...
      items: [
        ...
        {
          text: 'Elasticsearch 简介与安装',
          link: '/database/elasticsearch/introduction-install',
        },
